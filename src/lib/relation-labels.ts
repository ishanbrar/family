...
const SPANISH_LABELS: Record<string, string> = {
  ...
  "Parent-in-Law": "Suegra/Suegro",
  Daughter: "Hija",
  Son: "Hijo",
  Child: "Hija/Hijo",
  "Daughter-in-Law": "Nuera",
  "Son-in-Law": "Yerno",
  "Child-in-Law": "Nuera/Yerno",
  Sister: "Hermana",
  Brother: "Hermano",
  Sibling: "Hermana/Hermano",
  "Sister-in-Law": "Cuñada",
  "Brother-in-Law": "Cuñado",
  "Sibling-in-Law": "Cuñada/Cuñado",
  Wife: "Esposa",
  Husband: "Esposo",
...
const FRENCH_LABELS: Record<string, string> = {
  ...
  "Parent-in-Law": "Belle-mere/Beau-pere",
  Daughter: "Fille",
  Son: "Fils",
  Child: "Enfant",
  "Daughter-in-Law": "Belle-fille",
  "Son-in-Law": "Beau-fils",
  "Child-in-Law": "Belle-fille/Beau-fils",
  Sister: "Soeur",
  Brother: "Frere",
  Sibling: "Soeur/Frere",
  "Sister-in-Law": "Belle-soeur",
  "Brother-in-Law": "Beau-frere",
  "Sibling-in-Law": "Belle-soeur/Beau-frere",
  Wife: "Epouse",
  Husband: "Epoux",
  Spouse: "Conjoint",
